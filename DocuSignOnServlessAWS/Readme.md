...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *DocuSignOnServlessAWS*):

Restore dependencies
```
    cd "DocuSignOnServlessAWS"
    dotnet restore
```

Execute unit tests
```
    cd "DocuSignOnServlessAWS/test/DocuSignOnServlessAWS.Tests"
    dotnet test
```

Deploy application
```
    cd "DocuSignOnServlessAWS/src/DocuSignOnServlessAWS"
